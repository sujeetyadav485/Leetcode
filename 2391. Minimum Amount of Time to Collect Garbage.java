...
// Altogether, 
// it takes 8 minutes to pick up all the paper garbage.
...
// Altogether, 
// it takes 13 minutes to pick up all the glass garbage.
// Since there is no metal garbage, 
// we do not need to consider the metal garbage truck.
// Therefore, 
// it takes a total of 8 + 13 = 21 minutes to collect all the garbage.
...
class Solution {
    public static int garbageCollection(String[] garbage, int[] travel) {
        ...
        for (int mi = 0; mi < mMaxDist; mi++) {
            ans += travel[mi];
        }

        for (int gi = 0; gi < gMaxDist; gi++) {
            ans += travel[gi];
        }

        for (int pi = 0; pi < pMaxDist; pi++) {
            ans += travel[pi];
        }
...
// Success
// Details 
// Runtime: 81 ms, faster than 34.17% of Java online submissions for Minimum Amount of Time to Collect Garbage.
// Memory Usage: 75.3 MB, less than 91.82% of Java online submissions for Minimum Amount of Time to Collect Garbage.
