...
# From the head of A, 
# it reads as [4,1,8,4,5]. 
# From the head of B, 
# it reads as [5,6,1,8,4,5]. 
...
# In other words, 
# they point to two different locations in memory, 
...
# Explanation: 
# From the head of A, it reads as [2,6,4]. From the head of B, 
# it reads as [1,5]. Since the two lists do not intersect, 
# intersectVal must be 0, 
